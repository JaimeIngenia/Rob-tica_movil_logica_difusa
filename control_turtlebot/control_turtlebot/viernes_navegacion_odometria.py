...
class ControlNavegacion(Node):
    def __init__(self):
        ...
        self.goal_pose_x = -4 #Antes -4
        self.goal_pose_y = 4  #Antes 4
    ...
    def odomcallback(self, msg):
        ...
        self.last_pose_y = self.postn.x #self.postn.x
        self.last_pose_x = self.postn.y #self.postn.y
    ...
    def Turn(self, angle, angular_velocity, step):
        ...
        if math.fabs(angle) > 0.01:
            ...
            step = step + 1
            print("Deberiamos estar en el step 2 :" + str(step))
    ...
    def Straight(self, distance , linear_velocity, step):
        ...
        if distance > 0.08:
            ...
            step = step + 1
            print("Deberiamos estar en el step 3 :" + str(step))
            print("Posicion x ", self.postn.x, "|","Posicion y", self.postn.y, "|","Posicion z", self.postn.z)
            print("Orientacion x ", self.orient.x, "|","Orientacion y", self.orient.y, "|","Orientacion z", self.orient.z)
            print("")
